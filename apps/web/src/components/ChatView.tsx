...
function ChatViewContent(props: ChatViewProps) {
  ...
  const runSend = async (
    ...
    const bootstrapOverrides = {
      ...
      ...(composerInteractionMode ? { interactionMode: composerInteractionMode } : {}),
          ...
          >
            ...
            <div className="relative flex min-h-0 flex-1 flex-col">
              ...
              <MessagesTimeline
                ...
                // T3-CUSTOM(expbkt3): running != monitoring; only a running phase
                // starts the turn clock, and the running turn id comes from the
                // durable execution snapshot. (Upstream retired activeTurnInProgress.)
