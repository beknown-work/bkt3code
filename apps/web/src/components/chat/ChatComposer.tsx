...
export interface ChatComposerProps {
  ...
  // T3-CUSTOM(expbkt3): interrupt may await a durable stop request.
...
export const ChatComposer = memo(function ChatComposer(props: ChatComposerProps) {
  ...
  // T3-CUSTOM(expbkt3): composer-scoped drag-and-drop image attach.
      ...
      {showComposerTopDrawer && (!isTasksDrawerOpen || hasBlockingComposerTopDrawer) ? (
        ...
        >
          {!isComposerCollapsedMobile && activePendingApproval ? (
            ...
            // T3-CUSTOM(expbkt3): queued messages ride in the composer drawer so a
            // durable send stays visible while the environment is unavailable.
              ...
              >
                <div className="-m-1 -ms-3.5 flex min-w-0 flex-1 items-center gap-1 overflow-x-auto p-1 ps-3.5 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
                  ...
                  {isComposerFooterCompact ? (
                    <CompactComposerControlsMenu
                      ...
                      // T3-CUSTOM(expbkt3): reset a draft back to the project defaults.
                ...
                >
                  ...
                  <ComposerFooterPrimaryActions
                    ...
                    pendingAction={pendingPrimaryAction}
                    // T3-CUSTOM(expbkt3): stop reflects durable execution, not just the
                    // local phase, and a pending stop is shown while it lands.
                    isRunning={canStopExecution}
                    isStopPending={isStopPending}
                    showPlanFollowUpPrompt={
