...
describe("deriveActiveWorkStartedAt", () => {
  ...
  // T3-CUSTOM(expbkt3): upstream's case, expressed against the fork's execution
  // snapshot instead of session.status/activeTurnId.
  it("falls back to the latest user message while an active execution is being acknowledged", () => {
    expect(
      deriveActiveWorkStartedAt(
        latestTurn,
        {
