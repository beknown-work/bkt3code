...
export function deriveActiveWorkStartedAt(
  ...
  // (upstream keys this off session.status/activeTurnId). Upstream's
  // latestUserMessageAt fallback is kept for the acknowledgement window.
  if (
    execution &&
    ...
    return execution.turn?.startedAt ?? sendStartedAt ?? latestUserMessageAt;
