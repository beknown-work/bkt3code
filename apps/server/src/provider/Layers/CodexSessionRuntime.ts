...
// T3-CUSTOM(expbkt3): interrupting a recovered session without an active turn
// must fail instead of hanging the orchestration turn forever.
export class CodexSessionRuntimeNoActiveTurnError extends Schema.TaggedError<CodexSessionRuntimeNoActiveTurnError>()(
  "CodexSessionRuntimeNoActiveTurnError",
  {
    threadId: Schema.String,
  },
