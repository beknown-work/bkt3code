...
export const ThreadComposer = memo(function ThreadComposer(props: ThreadComposerProps) {
  ...
  // T3-CUSTOM(expbkt3): stop visibility follows authoritative execution, while drafts show Send.
  const showStopAction = !hasContent && props.selectedThread.execution?.canStop === true;
