...
import type {
  ...
  EnvironmentId,
  MessageId,
  // T3-CUSTOM(expbkt3): authoritative execution and catch-up cards.
...
// T3-CUSTOM(expbkt3): catch-up duration and anchored plan feedback.
...
export const ThreadFeed = memo(function ThreadFeed(props: ThreadFeedProps) {
  ...
  // T3-CUSTOM(expbkt3): unsettled work follows authoritative execution, not latestTurn.
      ...
      >
        <ThreadMediaVisibility>
          {renderFeedEntry(info, {
            ...
            // T3-CUSTOM(expbkt3): retain per-turn catch-up cards.
