...
// T3-CUSTOM(expbkt3): legacy sidebar quota-state extension.
...
const AccountRateLimitsUpdatedPayload = Schema.Struct({
  ...
  // T3-CUSTOM(expbkt3): full replacement and error semantics for the fork sidebar.
  rateLimits: Schema.optional(ProviderRateLimitUpdate),
});
